...
- Candidate backends represented by recommended adapters: `cpu`, `cuda`, `hip`, `mpi`, `opencl`, `openmp`, `sycl`, `task-parallel`.
- Candidate libraries: `cufft`, `kokkos`, `nccl`, `tensorrt`
- Edge-suitability classifications represented by recommended adapters: `limited`, `suitable`
