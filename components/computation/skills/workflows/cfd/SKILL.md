...
- Candidate backends represented by recommended adapters: `cpu`, `mpi`, `openmp`, `task-parallel`.
- Candidate libraries: `gpudirect-storage`, `nvcomp`
- Edge-suitability classifications represented by recommended adapters: `unsuitable`
