...
- Candidate backends represented by recommended adapters: `cpu`, `cuda`, `hip`, `mpi`, `openmp`, `remote`, `task-parallel`.
- Candidate libraries: `cublas`, `cufft`, `cupy`, `cusolver`, `cusparse`, `nccl`, `rapids-cudf`
- Edge-suitability classifications represented by recommended adapters: `limited`, `suitable`, `unsuitable`
