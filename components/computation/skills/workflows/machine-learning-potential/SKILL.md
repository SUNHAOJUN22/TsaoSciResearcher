---
name: machine-learning-potential
description: Machine-learning interatomic potentials workflow with explicit contracts, preflight, convergence, physical validation, uncertainty, provenance, and fail-closed acceptance.
---
...
Use this workflow for machine-learning interatomic potentials tasks after the root contract establishes the observable, scale, method, evidence, and resource boundary. Routing keywords include `deepmd`, `mace`, `ml potential`, `training`.
...
- Candidate backends represented by recommended adapters: `cpu`, `cuda`, `hip`, `mpi`, `task-parallel`.
- Candidate libraries: `cublas`, `cuequivariance`, `cutensor`, `nccl`, `tensorrt`
- Edge-suitability classifications represented by recommended adapters: `suitable`
