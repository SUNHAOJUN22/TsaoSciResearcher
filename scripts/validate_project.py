...
TRANSITIONS: dict[str, frozenset[str]] = {"proposed": frozenset({"planned", "rejected", "superseded"}), "planned": frozenset({"running", "rejected", "superseded"}), "running": frozenset({"completed", "rejected", "superseded"}), "completed": frozenset({"checked", "rejected", "superseded"}), "checked": frozenset({"validated", "rejected", "superseded"}), "validated": frozenset({"accepted", "rejected", "superseded"}), "accepted": frozenset({"superseded"}), "rejected": frozenset({"superseded"}), "superseded": frozenset()}
...
def validate(path: str | Path) -> dict[str, Any]:
    ...
    if data["status"] in {"validated", "accepted"} and not (data.get("hypotheses") or str(data.get("rationale", "")).strip()):
