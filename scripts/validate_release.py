...
from package_release import build_release, verify_sidecar


def main() -> None:
    with tempfile.TemporaryDirectory(prefix="tsr-release-a-") as first_dir, tempfile.TemporaryDirectory(prefix="tsr-release-b-") as second_dir, tempfile.TemporaryDirectory(prefix="tsr-release-extract-") as extract_dir:
        ...
        required = [extracted / "TsaoSciResearcher" / "SKILL.md", extracted / "TsaoSciResearcher" / "VERSION", extracted / "TsaoSciResearcher" / "scripts" / "package_release.py"]
